...
\begin{itemize}
  ...
  \item IOW and WCR $\implies$ WNFP \sacomment{We need to define these still (IOW and WNFP) in the report}
\end{itemize}
...
\begin{enumerate}
  ...
  \begin{itemize}
    ...
    \item ``If an $R^*$-sequence has a cocone then it's constant after some point on.''
  \end{itemize}
\end{enumerate} \sacomment{This is our recurrence property right? If so, we can just delete this.}
