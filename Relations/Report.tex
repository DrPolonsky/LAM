...
\begin{table}[h!]
  ...
  \hline
  \textbf{UN} & {CE-3}, {CE-12}  & CR, {CE-6}  & CE-3, {CE-9}  & CR, {CE-3}  & \red{CR} , SN \\
  \hline
  & \textbf{WR} & \textbf{WN} & \textbf{SR} & \textbf{WN}$\boldsymbol{\land}$\textbf{SR} & \textbf{SN} \\
  \hline  
  \end{tabular}
...
\begin{table}[h!]
  ...
  \textbf{CR} & CR, {CE-9}  & CR, {CE-6}  & CR , {CE-9}  & CR, ?  & CR , SN \\
  \hline
  \textbf{RP} & CR, {CE-9}  & CR, {CE-6}  & \red{CR} , {CE-9} & CR, ?   & CR , SN \\
  \hline
  \textbf{WNFP} & ?, {CE-9}  & CR, {CE-6}  & \red{CR} , {CE-9} & CR, ?   & CR , SN \\
  \hline
  \textbf{UN} & ?, {CE-9}  & CR, {CE-6}  & \red{CR}, {CE-9}  & CR, ?  & CR , SN \\
  \hline
  & \textbf{WR} & \textbf{WN} & \textbf{SR} & \textbf{WN}$\boldsymbol{\land}$\textbf{SR} & \textbf{SN} \\
  \hline  
  \end{tabular}
