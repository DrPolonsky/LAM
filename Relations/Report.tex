...
\begin{table}[h!]
  ...
  \hline
  \textbf{CR} & CR, WR  & CR, SR  & CR?, SR  &   &   \\
  \hline
  \textbf{RP} & CR, WR  & CR, SR  & CR?, SR &   &   \\
  \hline
  \textbf{NP} & NP, WR  & CR, WN  & NP, SR  &   &   \\
  \hline
  \textbf{UN} & UN, WR  & UN, WN  & UN, SR  & UN, WN$\land$SR  &   \\
  \hline
...
\begin{table}[h!]
  ...
  \hline
  \textbf{UN} & CE-3, CE-9  & CE-3, CE-6  & CE-3, CE-9  & CE-3, CE-3  &   \\
  \hline
  & \textbf{WR} & \textbf{WN} & \textbf{SR} & \textbf{WN}$\boldsymbol{\land}$\textbf{SR} & \textbf{SN} \\
  \hline  
  \end{tabular}
