...
\begin{table}[h!]
  ...
  \hline
  \textbf{CR} & CR, CE-9  & CR, CE-6  & CR , CE-9  & CR, CE-6  & CR , SN \\
  \hline
  \textbf{RP} & CR, CE-9  & CR, CE-6  & \red{CR} , CE-9 & CR, CE-6   & \red{CR} , SN \\
  \hline
  \textbf{WNFP} & CE-10, CE-9  & CR, CE-6  & CE-11 , CE-9 & CR, CE-6   & \red{CR} , SN \\
  \hline
  \textbf{UN} & CE-3, CE-9  & CE-3, CE-6  & CE-3, CE-9  & CE-3, CE-3  & \red{CR} , SN \\
  \hline
...
\begin{table}[h!]
  ...
  \begin{tabular}{|l|c|c|c|c|c|}     
  \hline
  \textbf{CR} & CR, CE-9  & CR, \blue{CE-6}  & CR , \blue{CE-9}  & CR, \blue{CE-6}  & CR , SN \\
  \hline
  \textbf{RP} & CR, CE-9  & CR, \blue{CE-6}  & \red{CR} , \blue{CE-9} & CR, \blue{CE-6}   & \red{CR} , SN \\
  \hline
  \textbf{WNFP} & CE-10, CE-9  & CR, \blue{CE-6}  & \blue{CE-11} , \blue{CE-9} & CR, \blue{CE-6}   & \red{CR} , SN \\
  \hline
  \textbf{UN} & CE-3, CE-9  & \blue{CE-3}, \blue{CE-6}  & \blue{CE-3}, \blue{CE-9}  & \blue{CE-3}, \blue{CE-3}  & \red{CR} , SN \\
  \hline
  & \textbf{WR} & \textbf{WN} & \textbf{SR} & \textbf{WN}$\boldsymbol{\land}$\textbf{SR} & \textbf{SN} \\
  \hline  
  \end{tabular}
...
\begin{table}[h!]
  ...
  \begin{tabular}{|l|c|c|c|c|c|}     
  \hline
  \textbf{CR} & CR, \blue{CE-9}  & CR, \blue{CE-6}  & CR , \blue{CE-9}  & CR, \blue{CE-6}  & CR , SN \\
  \hline
  \textbf{RP} & CR, \blue{CE-9}  & CR, \blue{CE-6}  & \red{CR} , \blue{CE-9} & CR, \blue{CE-6}   & \blue{CR} , SN \\
  \hline
  \textbf{WNFP} & \blue{CE-10}, \blue{CE-9}  & CR, \blue{CE-6}  & \red{CR} , \blue{CE-9} & CR, \blue{CE-6}   & \blue{CR} , SN \\
  \hline
  \textbf{UN} & \blue{CE-3}, \blue{CE-9}  & CR, \blue{CE-6}  & \red{CR}, \blue{CE-9}  & \blue{CE-3}, \blue{CE-3}  & \blue{CR} , SN \\
  \hline
  & \textbf{WR} & \textbf{WN} & \textbf{SR} & \textbf{WN}$\boldsymbol{\land}$\textbf{SR} & \textbf{SN} \\
  \hline  
  \end{tabular}
...
\begin{table}[h!]
  ...
  \textbf{CR} & CR, \blue{CE-9}  & CR, \blue{CE-6}  & CR , \blue{CE-9}  & CR, \blue{CE-6}  & CR , SN \\
  \hline
  \textbf{RP} & CR, \blue{CE-9}  & CR, \blue{CE-6}  & \red{CR} , \blue{CE-9} & CR, \blue{CE-6}   & CR , SN \\
  \hline
  \textbf{WNFP} & \blue{CE-10}, \blue{CE-9}  & CR, \blue{CE-6}  & \red{CR} , \blue{CE-9} & CR, \blue{CE-6}   & CR , SN \\
  \hline
  \textbf{UN} & \blue{CE-3}, \blue{CE-9}  & CR, \blue{CE-6}  & \red{CR}, \blue{CE-9}  & \blue{CE-3}, \blue{CE-3}  & CR , SN \\
  \hline
  & \textbf{WR} & \textbf{WN} & \textbf{SR} & \textbf{WN}$\boldsymbol{\land}$\textbf{SR} & \textbf{SN} \\
  \hline  
  \end{tabular}
