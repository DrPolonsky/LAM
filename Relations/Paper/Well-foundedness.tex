...
\apcomment{Move this comment elsewhere? Perhaps we should have a separate discussion between isWFseq- and isWFseq-not-not?} 
...
% \label{tab:classical_properties}
% \begin{tabular}{@{}l p{10cm}@{}}
% \toprule
% \textbf{Property} & \textbf{Definition} \\
% \midrule
% $\accDNE$ & [Fill in: Definition of accDNE] \\
% $\rdec$ & [Fill in: Definition of rdec] \\
% $\accCor$ & [Fill in: Definition of accCor] \\
% $\mpe$ & [Fill in: Definition of mpe] \\
% $\FB$ & [Fill in: Definition of FB] \\
% $\corDNE$ & [Fill in: Definition of corDNE] \\
% \bottomrule
% \end{tabular}
% \end{table}
