...
\begin{definition}
  ...
  \begin{enumerate}
    ...
    \item $P \subseteq A$ is \emph{coreductive} if, for each $x \in A$, $x \notin P$ implies $\exists y \in A$ such that $Ryx$ and $y \notin P$. 
  \end{enumerate}
\end{definition}
...
\sacomment{Do we want local or global definitions here?}
\begin{definition}
  Let $R \subseteq A \times A$. We write $Rxy$ when $(x,y) \in R$.
  \begin{enumerate}
    \item $R$ is \emph{accessibly well-founded} ($\WFacc$) if every element is accessible:
      ...
      \]
    \item $R$ is \emph{inductively well-founded} ($\WFind$) if every inductive $P \subseteq A$ is universal:
      \[
    ...
    \item $R$ is \emph{sequentially well-founded} ($\WFseq$) if every sequence contains an index at which it is not decreasing:
      \[
        \forall s : \nat \to A \exists k : \nat.\, \lnot \, R \,(s\,k)\,(s\,(k+1)).
      \]
    \item  $R$ is \emph{minimally well-founded} ($\WFmin$) if every nonempty subset has a $P$-minimal element:
      \[
        \forall P \subseteq A.\; P \neq \varnothing \Rightarrow
        \exists x \in P.\; \text{$x$ is $P$-minimal}.
      \]
    \item  $R$ is \emph{minimally well-founded under double negation elimination} ($\WFminDNE$) if every nonempty $\lnot \lnot$-closed subset contains a $P$-minimal element:
      \[
        \forall P \subseteq A.\; P \neq \varnothing \Rightarrow (\lnot \lnot P \Rightarrow P) \Rightarrow
        \exists x \in P.\; \text{$x$ is $P$-minimal}.
      \]
    \item $R$ is \emph{coreductively well-founded} ($\WFcor$) if every coreductive $P \subseteq A$ is universal:
...
To explore how these definitions interrelate it helps to consider the following corresponding weaker definitions (which are formalized in \texttt{WFWeakDefinitions}). 
...
\begin{definition}
  ...
  \begin{enumerate}
    ...
    \item $R$ is \emph{weakly sequentially well-founded} ($\WFseqm$) if no sequence is $R$-decreasing:
      ...
      \]
    \item  $R$ is \emph{weakly minimally well-founded} ($\WFmin$) if every nonempty subset contains a $\lnot \lnot P$-minimal element:
      \[
        \forall P \subseteq A.\; P \neq \varnothing \Rightarrow \lnot \lnot \;
        (\exists x \in P.\; \text{$x$ is $P$-minimal}).
      \]
    \item  $R$ is \emph{weakly minimally well-founded under double negation elimination} ($\WFminDNE$) if every nonempty $\lnot \lnot$-closed subset $\lnot \lnot$ contains a $P$-minimal element:
      \[
        \forall P \subseteq A.\; P \neq \varnothing \Rightarrow (\lnot \lnot P \Rightarrow P) \Rightarrow \lnot \lnot \;
        (\exists x \in P.\; \text{$x$ is $P$-minimal}).
      \]      
  \end{enumerate}
\end{definition}
