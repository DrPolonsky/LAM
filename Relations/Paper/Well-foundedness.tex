...
On the other hand, the implication from the sequential to inductive definition
...
and $y$ not accessible.  Assuming \accCor, all notions of well-foundedness
...
\begin{enumerate}
  ...
  (Just like isWFminDNE is a natural weakening of isWFmin sufficient to recover isWFacc
  when {\accDNE} is available.)
