...
\]
This is stronger than deciding whether $x$ is a normal form:
...
Indeed, in the file \texttt{ARS/Examples.agda} the implication $\gSN \to \gWN$ 
is equivalent to the principle of excluded middle.
