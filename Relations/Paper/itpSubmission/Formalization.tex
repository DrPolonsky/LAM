...
\begin{remark} \hfill
  \begin{description}
    ...
    \apcomment{In Terese, this statement is BP and Inc implies SN.
      Replacing Inc with the weaker property RP, we can imply SM.  The conclusion to SN follows if BP is strengthened in converse of (i), 
    to WN and UNeq.} 
    With the original property $\gBP$ and $\gRP$ we can imply the related property $\gSM$ ($\gSM$ is defined in Section~\ref{sec:Hierarchy} and its relation to $\gSN$ is expanded upon). The definition and further discussion of $\isWFseqm$ is provided in Section~\ref{sec:Well-foundedness}.
