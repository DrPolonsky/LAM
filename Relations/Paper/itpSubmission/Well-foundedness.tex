...
\begin{definition} \label{def:WFproperties} \hfill
  \begin{itemize}
    \item $R$ is \emph{accessibly well-founded} ($\WFacc$) if every element is accessible:
      ...
      \]
    \item %\label{def:WFind}
      $R$ is \emph{inductively well-founded} ($\WFind$) if every inductive predicate holds:
      \[
        \forall P \subseteq A.\;\text{$P$ is inductive} \Rightarrow \forall x \in A.\; x \in P
      \]
    \item $R$ is \emph{coreductively well-founded} ($\WFcor$) if every coreductive predicate holds:
      \[
        \forall P \subseteq A.\;\text{$P$ is coreductive} \Rightarrow \forall x \in A.\; x \in P
      \]
    \item $R$ is \emph{well-founded minimality-wise} ($\WFmin$) if nonempty subsets have minimal elements:
      \[
        \forall P \subseteq A.\; P \neq \varnothing \Rightarrow
        \exists x \in A.\; \text{$x$ is $P$-minimal}
      \]
    \item  $R$ is \emph{well-founded minimality-wise for $\lnot \lnot$-closed predicates} ($\WFminDNE$) if every nonempty $\lnot \lnot$-closed subset has a minimal element:
      \[
...
\begin{definition} \label{def:WFweakproperties} \hfill
  \begin{itemize}
    \item $R$ is \emph{weakly accessibly well-founded} ($\WFaccm$) if every element is $\lnot\lnot$-accessible: %accessibility holds for all elements up to double negation:
      \[
