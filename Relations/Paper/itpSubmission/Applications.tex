...
(The second author learned of this encoding from H\aa{}kon Gylterud; it seems to be quite popular in the Haskell community.)
...
\begin{itemize}
  ...
  \item The encoding suggests the general higher-order induction combinator that suffices to derive standard results like the substitution lemma;
...
definitions of undecidable lambda theories based on identifications of unsolvable terms ($\mcH$ and $\mcHo$), 
and a formalization of an unpublished result on characterizing 2-cycles, based on earlier collaboration with Jan Willem Klop and Joerg Endrullis. As an example of how our ARS library makes an appearence, some basic implications come completely for free: 
\begin{description}
...
\end{description}
While all these facts are easy and could have been proved directly, the fact that they can be obtained as consequences of the general theory 
illustrates the whole point: they shouldn't have to be proved at all, and now they don't have to be.

Yet one remarkable aspect of this application is that the heterogeneous nature of the datatype in no way interfered with the classical, Terese-style 
...
It was a surprise to see what first appears as a namespace management system to be so useful in relating results with a high level of generality.
