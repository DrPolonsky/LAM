...
\texttt{Implications.agda}. % inside the \texttt{ARS} folder.
...
\end{figure}
% \FloatBarrier
The counterexamples demonstrate how a given combination of properties are insufficient to provide either $\CR$ or $\SN$ in Table~\ref{tab:localImplications} and Table~\ref{tab:globalImplications}.
