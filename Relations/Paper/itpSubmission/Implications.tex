...
\end{figure}
\FloatBarrier
The counterexamples demonstrate how a given combination of properties are insufficient to provided either $\CR$ or $\SN$ in Table~\ref{tab:localImplications} and Table~\ref{tab:globalImplications}.
