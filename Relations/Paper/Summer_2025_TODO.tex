...
\begin{todolist}
  ...
  \item Remove "desired implications" and similar organizational issues in the code (general review)
  \item Consider defining FB in terms of existing list library; especially in the rebooted repo,
  we shouldn't use manual List type just for this.
  \item Move all definitions and properties from Section 2.3 to Seq.agda, except Inc.
  \item Revise section 3.1
\end{todolist}
\end{document}
