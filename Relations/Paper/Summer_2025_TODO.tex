...
\begin{todolist}
  ...
  \item Make consistent how we display definitions. \sacomment{I've made a change which I think looks better (bullet point style.) If we're happy with this change we can apply it to the wellfoundedness section too unless we rely on the numbering/reference the numbers}
  ...
  \item Check the PLDI page for submission rules/requirements. In particular the bibliography style 
  \item [\done] Run through and compile everything, make sure we didn't introduce any bugs
  \item Check the layout of figures through the paper. Counterexamples for example is currently `off'. 
  \item Submit 
  \item Add a paragraph or two giving a short overview/summary of Agda.
  ...
  \item make an external bibliography file rather than inlining in main file. Make sure bibliography is up to standard (e.g. emph on book title).
