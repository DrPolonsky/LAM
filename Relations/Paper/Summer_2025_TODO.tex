...
\item make an external bibliography file rather than inlining in main file.
\end{todolist}
...
\item Need to fix how we put urls in for bibliography. Currently not quite working. \sacomment{Now all urls, if happy with how it looks we can tick it off. }
