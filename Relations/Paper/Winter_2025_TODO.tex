...
\begin{todolist}
  ...
  \item Work out what if any WF definition implies WEM (other than WFmin)?
  ...
  \item TRS: Complete our formalization. formalize some simple TRS to check our implementation works. 
  ...
  \item Shown wfmindne not not implies wfacc not not with accDNE. Now need to update the paper/graph to reflect this.
  ...
  \item What can we do with wfminDNE now that we have WEM? 
\end{todolist}  
