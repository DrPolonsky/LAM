...
required to complete the implication from $\SN$ to $\WN$, as can be seen in our formalization \sacomment{Rewrite this section}
...
there is no other element to which they have a relation. \greyout{If the element relates to no other element then it is terminating 
