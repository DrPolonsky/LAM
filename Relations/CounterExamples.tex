...
\subsection{Counterexample 3} \sacomment{This counterexample doesn't work. Keeping it as a useful reminder.}
\begin{center}
  \begin{tikzpicture}
...
\sacomment{Check the tex file for the notes below which have been commented out.}
